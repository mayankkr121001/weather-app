...
function App() {
  ...
  async function onSearchClick() {
    setCity(capitalizeFirst(city));


    await axios.get(`http://api.weatherapi.com/v1/forecast.json?key=${import.meta.env.VITE_NEW_WEATHER_API_KEY}&q=${city}&days=1&aqi=no&alerts=no`)
      .then((response) => {
        ...
        <div className="weatherSection">
          <div className="weatherSectionLeftDiv">
            <div className="searchDiv">
              <input onInput={cityInputFunc} type="text" placeholder='Search for cities' />
